...
export const removeRowsInRedux = (dispatch, Row, codigo) =>{
...
/*
const nroList = [
{idAccordion: 1, statement: 'Universitarios', accordionStatement: 'General', multiplicador: 2.3, codeBet: 'DCUxpcpr'},
{idAccordion: 1, statement: 'Empate', accordionStatement: 'General', multiplicador: 1.4, codeBet: 'nKDPVYoQ'},
{idAccordion: 1, statement: 'Sporting cristal', accordionStatement: 'General', multiplicador: 1.4, codeBet: 'OCMmyOiS'},
{idAccordion: 2, statement: 'mas de 1.5', accordionStatement: 'Nro de goles/1er Tiempo', multiplicador: 1.4, codeBet: 'dCcZHmll'},
{idAccordion: 3, statement: 'Sporting cristal o Empate', accordionStatement: 'Doble Oportunidad', multiplicador: 1.4, codeBet: 'eWVjQQYv'},
{idAccordion: 3, statement: 'Universitario o Sporting cristal', accordionStatement: 'Doble Oportunidad', multiplicador: 2.3, codeBet: 'JCpksFni'},
{idAccordion: 4, statement: 'Sporting cristal', accordionStatement: 'Apuesta sin empate', multiplicador: 1.4, codeBet: 'ybguDrKo'}
]
