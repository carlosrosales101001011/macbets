...
export const MACBetsBody = () => {
    ...
    // console.log(Row);/
    // console.log(NewArray(Row).map(b=>b.bets));
    useEffect(() => {
    ...
    let packApuestas = {
      bet1: new ModeloApuesta('21/09/2023', '12:00:00', 'champions', 'Sporting cristal vs Universitario', null, 'POLIK9')
                .addAccordionName("gtQyksw", 'General', [
                                      ...
                                      {code: 'DCUxpcpr', inCupon: false, statement: 'Universitarios', multiplied: 2.3}], {inCuponAccordion: false})
                .addAccordionName("CDMSXOi", 'Nro de goles/1er Tiempo', [
                                      {code: 'dCcZHmll', inCupon: false, statement: 'mas de 1.5', multiplied: 1.4}, 
                                      {code: 'FNhkeZvC', inCupon: false, statement: 'menos de 1.5', multiplied: 3.2}], {inCuponAccordion: false})
                .addAccordionName("jkgCdyd", 'Doble Oportunidad', [
                                      ...
                                      {code: 'QOBdTkek', inCupon: false, statement: 'Universitario o Empate', multiplied: 2.3}], {inCuponAccordion: false})
                .addAccordionName("QLGHTzN", 'Apuesta sin empate', [
                                      {code: 'ybguDrKo', inCupon: false, statement: 'Sporting cristal', multiplied: 1.4}, 
                                      {code: 'RvqpyRLN', inCupon: false, statement: 'Universitario', multiplied: 3.2}], {inCuponAccordion: false}),
      bet2: new ModeloApuesta('21/09/2022', '18:00:00', 'champions', 'Peru vs Argentina h', null, 'KILOO0')
                .addAccordionName("yUXSOlZ", 'Z', [
                                            ...
                                            {code: 'epdZuMia', inCupon: false, statement: 'bbbb', multiplied: 4.1}], {inCuponAccordion: false})
                .addAccordionName("okQeBEM", 'Y', [
                                            ...
                                            {code: 'uaDSNeOW', inCupon: false, statement: 'bbbb', multiplied: 4.1}], {inCuponAccordion: false}),
      bet3: new ModeloApuesta('21/09/2022', '18:00:00', 'champions', 'Sporting cristal vs Universitario ho', null, 'KILO21')
                .addAccordionName("ryMaDab", 'Z', [
                                            ...
                                            {code: 'DqodLHHH', inCupon: false, statement: 'bbbb', multiplied: 4.1}], {inCuponAccordion: false})
                .addAccordionName("mDdDDmk", 'Y', [
      ...
      bet4: new ModeloApuesta('21/09/2022', '18:00:00', 'champions', 'Sporting cristal vs Universitario hola', null, 'KILO34')
                .addAccordionName("DOJgPky", 'Z', [
                                            ...
                                            {code: 'oCkxVwFc', inCupon: false, statement: 'bbbb', multiplied: 4.1}], {inCuponAccordion: false})
                .addAccordionName("WJjXtXt", 'Y', [
